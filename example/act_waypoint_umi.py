...
def main(args):
    ...
    # load data for i in tqdm(range(args.start_idx, args.end_idx + 1)):
    for i in tqdm(range(args.start_idx, args.end_idx + 1)):
        # '/home/xiuxiu/PycharmProjects/mobilealoha/data/public_mobile_aloha_datasets/debug_session/episode_0.hdf5'
        dataset_path = os.path.join(args.dataset, f"episode_{i}.hdf5")
        print(dataset_path)
        with h5py.File(dataset_path, "r+") as root:
            root.attrs['sim'] = False
            qpose = root["/observations/qpose"][()]  # (300,6)
            left_arm_ee = np.zeros_like(qpose)
            right_arm_ee = qpose
            ...
            # waypoints = greedy_waypoint_selection( # if it's too slow, use greedy_waypoint_selection
                env=None,
                actions=qpos,
                gt_states=qpos,
            ...
            if args.plot_3d:
                ...
                print(f"plot/act/{args.dataset.split('/')[-1]}_{i}_t_{args.err_threshold}_waypoints.png")
                fig.savefig(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        # default="/home/xiuxiu/PycharmProjects/mobilealoha/data/public_mobile_aloha_datasets/sim_transfer_cube_human",
        # default="/home/xiuxiu/PycharmProjects/mobilealoha/data/public_mobile_aloha_datasets/sim_insertion_human",
        # default="/home/xiuxiu/PycharmProjects/mobilealoha/data/public_mobile_aloha_datasets/debug_session",
        default="/home/xiuxiu/PycharmProjects/mobilealoha/data/public_mobile_aloha_datasets/doll_basket_session",
    ...
    # error threshold for reconstructing the trajectory 0.05
    parser.add_argument(
        "--err_threshold",
        type=float,
        default=0.01,
