...
import pathlib
import os
DATA_DIR = '/home/xiuxiu/PycharmProjects/mobilealoha/data/public_mobile_aloha_datasets'
# DATA_DIR = '/home/edge/interbotix_ws/src/universal_manipulation_interface'  # umi采集数据
# DATA_DIR = os.path.expanduser('~/data/aloha/')
TASK_CONFIGS = {
    'doll_basket_session':{
        'dataset_dir': DATA_DIR + '/doll_basket_session',
        'episode_len': 600,
        "num_episodes": 52,
        'train_ratio': 0.9,
    ...
    'debug_session':{
            'dataset_dir': DATA_DIR + '/debug_session',
            'episode_len': 1000,
            'train_ratio': 0.9,
            'camera_names': ['cam_right_wrist']
        },
    ...
    # static
    'aloha_vinh_cup_compressed': {
        'dataset_dir': DATA_DIR + '/aloha_static_cotraining_datasets/aloha_vinh_cup_compressed',
        'episode_len': 1300,
        'train_ratio': 0.9,
        'camera_names': ['cam_high', 'cam_left_wrist', 'cam_right_wrist']
    },
    ...
    'aloha_mobile_wipe_wine_cotrain':{
        'dataset_dir': [
            ...
            DATA_DIR + '/aloha_static_cotraining_datasets/aloha_vinh_cup_compressed',
            # DATA_DIR + '/aloha_compressed_dataset',
        ], # only the first dataset_dir is used for val
        'stats_dir': [
            DATA_DIR + '/aloha_mobile_wipe_wine',
